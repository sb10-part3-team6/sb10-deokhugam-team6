...
public class RankPopularReviewTasklet implements Tasklet {
  ...
  private UUID getSnapshotId(){
    if (snapshotIdValue == null || snapshotIdValue.isBlank()) {
      throw new InvalidJobParameterException(Map.of("snapshotId", snapshotIdValue != null ? snapshotIdValue : "null"));
    }
    try {
  ...
  private LocalDateTime getAggregatedAt(){
    if(aggregatedAtValue == null || aggregatedAtValue.isBlank()){
        throw new InvalidJobParameterException(Map.of("aggregatedAt", aggregatedAtValue != null ? aggregatedAtValue : "null"));
    }
    try {
  ...
  private PeriodType getPeriodType(){
    if(periodTypeValue == null || periodTypeValue.isBlank()){
      throw new InvalidJobParameterException(Map.of(
          "periodType",periodTypeValue != null ? periodTypeValue : "null"));
    }
    try {
